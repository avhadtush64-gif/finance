// frontend/components/TransactionRow.jsx
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex flex-col">
          <span className="font-medium text-gray-200">
            ...
            ${transaction.is_refund ? html`<span className="ml-2 text-xs text-emerald-500 font-normal px-1.5 py-0.5 bg-emerald-500/10 rounded">Refund</span>` : ''}
          </span>
